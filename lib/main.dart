...
import 'package:statefullwidgetandmap/widget/dropdown.dart';
import 'package:statefullwidgetandmap/widget/input.dart';
import 'package:statefullwidgetandmap/widget/konversi.dart';
import 'package:statefullwidgetandmap/widget/result.dart';
import 'package:statefullwidgetandmap/widget/riwayat.dart';
...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          title: Text('Konversi Suhu - (2031710068 - Faiza Nur Abida)'),
        ),
        body: Container(
